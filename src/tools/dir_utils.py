...
import fnmatch
import pathlib
from tools import config_utils
import logging
...
def create_dir(stock):
    ...
    for file in yaml_files:
        with open(file, 'rb') as f:
            ...
            cfg = config_utils.merge_new_config(config=cfg, new_config=temp)
            name = cfg.NAME
    ...
    for cfg in cfg_list:
        ...
        if err > 0 and err < 3:
            logging.warning(
                '> Some configuration files were missing, we recommend training this stock again.')
